...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Spider-Man 2: Enter Electro",
    .project_root_env = "SPIDER_MAN_2_ENTER_ELECTRO_PROJECT_ROOT",
    .build_dir_env = "SPIDER_MAN_2_ENTER_ELECTRO_BUILD_DIR",
    .force_setup_env = "SPIDER_MAN_2_ENTER_ELECTRO_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_013.78_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Spider_Man_2_Enter_Electro",
    .prepare_note =
