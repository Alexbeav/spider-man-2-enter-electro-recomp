...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/spider-man-2-enter-electro-recomp/total)](https://github.com/Alexbeav/spider-man-2-enter-electro-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/spider-man-2-enter-electro-recomp/latest/total)](https://github.com/Alexbeav/spider-man-2-enter-electro-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/spider-man-2-enter-electro-recomp)](https://github.com/Alexbeav/spider-man-2-enter-electro-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Spider-Man 2: Enter Electro** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLUS-01378 disc image
...
|---|---|
| Region | USA |
| Disc serial | SLUS-01378 |
| Discs | 1 |
| Supported dump | Redump `Spider-Man 2 - Enter - Electro (USA) (Rev 1).cue` as CUE/BIN or CHD |
| BIOS | SCPH-1001 (USA), 524288 bytes, SHA-256 `71af94d1e47a68c11e8fdb9f8368040601514a42a5a399cda48c7d3bff1e99d3` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/spider-man-2-enter-electro-recomp/releases)
   and extract it into a writable folder.
2. Start `Spider_Man_2_Enter_Electro` (`.exe` on Windows).
...
named `diagnostic-mode.txt` next to `Spider_Man_2_Enter_Electro.exe` and start the game as
usual, or run `Spider_Man_2_Enter_Electro.exe --diagnostic`. Reproduce the problem, quit, then
run `Spider_Man_2_Enter_Electro.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
